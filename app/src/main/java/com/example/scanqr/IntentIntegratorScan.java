...
public final class IntentIntegratorScan {

    public static final int REQUEST_CODE = 0x0ba7c0de; // get it?

    public static final String DEFAULT_TITLE = "Barcode Application";
    public static final String DEFAULT_MESSAGE =
            "This application requires Barcode Scanner Application. You have to install it.";
    public static final String DEFAULT_YES = "Yes";
    public static final String DEFAULT_NO = "OK";
